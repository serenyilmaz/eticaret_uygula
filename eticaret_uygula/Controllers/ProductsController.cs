...
namespace eticaret_uygula.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.kateliste = new SelectList(_context.Categories, "CategoryId", "CategoryName");//VİEW İÇERİSİNE VERİ GÖNDERMEK İÇİN "VİEWBAG" KULLANILIR.
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductCode,ProductDescription,ProductPicture,ProductPrice,CategoryId")] Products 
            products,IFormFile ImageUpload) //Dosyamızın ismini buraya yazdık.
        {
            if(ImageUpload != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductCode,ProductDescription,ProductPicture,ProductPrice,CategoryId")] Products 
            products,IFormFile ImageUpload)
        {
